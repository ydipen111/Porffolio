      ...
      <div className='grid grid-cols-2 pt-[80px] gap-20 ssm:pt-[40px]'>
        <div className='col-span-1 mmd:col-span-2'>
          ...
          <p className='text-xl mmd:text-lg text-gray-700 leading-loose pt-7'>
            ...
            and Instagram, where I regularly post valuable content related to web development, programming, and AI, fostering a culture of learning and growth. <br />
          </p>
        </div>
        <div className='col-span-1 mmd:col-span-2 ssm:py-7  '>
          ...
          <ul className='pr-3 flex flex-wrap gap-3 my-2 ssm:px-0'> {/* Adjusted margin and used gap */}
            ...
            <li className='text-gray-900 bg-gray-300 inline text-lg mmd:text-lg rounded-md px-4 py-2'>RTK QUERY AND MUTATION </li>
            <li className='text-gray-900 bg-gray-300 inline text-lg mmd:text-lg rounded-md px-4 py-2'>Data Archiving & OCR </li>
