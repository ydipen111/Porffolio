...
export default function Project() {
  return (
    <div className='px-4 py-7 '>
      <h1 className='tracking-wider text-3xl font-bold text-center'>PROJECTS</h1>
      <div className='flex justify-center py-6'>
        <label className="border-b-[8px]  rounded-md w-8  border-customPurple" htmlFor=""></label>
      </div>

      <p className='text-center font-medium text-gray-700 tracking-wide text-lg ssm:text-start '>Here you will find some of the personal and clients projects that I created with each project containing its own case study
      </p>
      ...
      <div className='grid grid-cols-2 gap-10  ssm:gap-4 mt-4 ssm:px-0'>
        ...
        <div className='col-span-2 flex mmd:flex-col'>
          <div>project</div>
          <div>Description</div>
        </div><div className='col-span-2 flex mmd:flex-col'>
          <div>project</div>
          <div>Description</div>
        </div>
